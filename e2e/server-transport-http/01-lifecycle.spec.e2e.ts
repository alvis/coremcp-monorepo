...
describe('server-transport-http / 01-lifecycle', () => {
  ...
  describe('graceful shutdown', () => {
    it('should handle server shutdown and become unreachable [LIFECYCLE-006]', async () => {
       ...
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/transport.ts#L49-L67 (ServerTransport installs SIGINT/SIGTERM shutdown handlers)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/transport.ts#L102-L128 (ServerTransport.start/stop manage the transport lifecycle and readiness)
       */
    ...
    it('should accept connections on the MCP endpoint before shutdown [LIFECYCLE-006]', async () => {
       ...
       * @see https://modelcontextprotocol.io/specification/2025-11-25/basic/lifecycle#http
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server-fastify/src/routes/mcp.ts#L34-L49 (registerMcpRoutes exposes the MCP HTTP routes used while the server is running)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/transport.ts#L102-L117 (ServerTransport.start marks the server ready for connections)
       */
  ...
  describe('HTTP DELETE session termination', () => {
    it('should terminate session via DELETE and reject subsequent requests [LIFECYCLE-006]', async () => {
       ...
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/server.ts#L387-L403 (terminateSession cleans up the active session and drops it from storage)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/utilities/session-authorization.ts#L46-L57 (missing sessions raise RESOURCE_NOT_FOUND for subsequent requests)
       */
  ...
  describe('session expiry', () => {
    it('should return 404 for invalid session ID [LIFECYCLE-007]', async () => {
       ...
       * @see https://modelcontextprotocol.io/specification/2025-11-25/basic/transports#session-management
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/server.ts#L547-L553 (requests validate session existence before handling)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/server/src/utilities/session-authorization.ts#L46-L57 (invalid session IDs produce RESOURCE_NOT_FOUND)
       */
