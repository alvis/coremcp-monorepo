...
describe('resources/list', () => {
  serverHttpTest(
    'should list all resources [RESOURCE-001]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should include resource metadata in listing [RESOURCE-001]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('resources/read', () => {
  serverHttpTest(
    'should read text resource [RESOURCE-002]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should read binary resource as blob [RESOURCE-003]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should read JSON resource [RESOURCE-002]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('resources/templates/list', () => {
  serverHttpTest(
    'should list resource templates [RESOURCE-004]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should include template metadata [RESOURCE-004]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('resources/subscribe', () => {
  serverHttpTest(
    'should subscribe to resource updates [RESOURCE-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should handle subscription to nonexistent resource [RESOURCE-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('resources/unsubscribe', () => {
  serverHttpTest(
    'should unsubscribe from resource updates [RESOURCE-006]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('resources/list pagination', () => {
  serverHttpTest(
    'should paginate resources with cursor-based navigation [RESOURCE-001]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
      ...
      const secondPage = await connector.sendRequest<{
        resources: Array<{ uri: string; name: string; mimeType?: string }>;
        nextCursor?: string;
      }>({
      ...
      expect(secondPage.resources.every((r) => !firstUris.has(r.uri))).toBe(
        true,
      );
    },
  );
...
describe('resources/subscribe cycle', () => {
  serverHttpTest(
    'should receive updated notification after subscribing and triggering change [RESOURCE-005]',
    async () => {
      // SPEC ALIGNMENT: PASS
      /**
      ...
      try {
        ...
        await notifyContext.connector.subscribeToResource('test://text/1');

        // trigger a resource updated notification via the trigger tool
        await notifyContext.connector.callTool('trigger-resource-updated', {
          uri: 'test://text/1',
        });
        ...
        const result =
          await notifyContext.connector.readResource('test://text/1');
        expect(result.contents).toHaveLength(1);
      } finally {
...
describe('resources/list_changed notification', () => {
  serverHttpTest(
    'should receive list_changed notification when triggered [RESOURCE-007]',
    async () => {
      // SPEC ALIGNMENT: PASS
      /**
