...
describe('POST with JSON response', () => {
  serverHttpTest(
    'should respond to tools/list via POST with JSON [TRANSPORT-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should respond to resources/list via POST with JSON [TRANSPORT-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should respond to tool call via POST with JSON [TRANSPORT-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should respond to ping via POST [TRANSPORT-005]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('session management', () => {
  serverHttpTest(
    'should maintain session across multiple requests [TRANSPORT-008]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should assign new session after disconnect and reconnect [TRANSPORT-008]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('concurrent operations', () => {
  serverHttpTest(
    'should handle parallel requests [TRANSPORT-008]',
    async ({ connector }) => {
      // SPEC ALIGNMENT: PASS
      /**
      ...
      const operations = [
        ...
        connector.callTool('add', { a: 10, b: 20 }),
        connector.listTools(),
...
describe('SSE via POST', () => {
  serverHttpTest(
    'should return SSE content type when Accept includes text/event-stream [TRANSPORT-006]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('GET SSE stream', () => {
  serverHttpTest(
    'should accept GET with session ID for SSE stream [TRANSPORT-007]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('DELETE session', () => {
  serverHttpTest(
    'should terminate session via DELETE request [TRANSPORT-009]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should reject requests after session termination [TRANSPORT-010]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
      ...
      const postResponse = await fetch(mcpEndpoint, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Mcp-Session-Id': rawSession.sessionId,
...
describe('MCP-Protocol-Version header', () => {
  serverHttpTest(
    'should accept requests with correct MCP-Protocol-Version header [TRANSPORT-013]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
  ...
  serverHttpTest(
    'should reject requests with wrong MCP-Protocol-Version header [TRANSPORT-013]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('Origin validation', () => {
  serverHttpTest(
    'should handle request with foreign Origin header [TRANSPORT-014]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('notification POST response', () => {
  serverHttpTest(
    'should respond with 202 Accepted and empty body for a JSON-RPC notification [TRANSPORT-005]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
...
describe('health endpoint', () => {
  serverHttpTest(
    'should respond on the health endpoint [TRANSPORT-005]',
  ...
  serverHttpTest(
    'should accept connections on the MCP endpoint [TRANSPORT-005]',
    async ({ mcpEndpoint }) => {
      // SPEC ALIGNMENT: PASS
      /**
      ...
      const response = await fetch(mcpEndpoint, { method: 'GET' });
