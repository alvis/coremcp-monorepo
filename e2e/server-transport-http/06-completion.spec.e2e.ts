...
serverHttpTest(
  'should complete prompt arguments [COMPLETION-001]',
  async ({ connector }) => {
    // SPEC ALIGNMENT: PASS
    /**
...
serverHttpTest(
  'should complete resource template arguments [COMPLETION-002]',
  async ({ connector }) => {
    // SPEC ALIGNMENT: PASS
    /**
...
serverHttpTest(
  'should return empty completions for unknown prefix [COMPLETION-001]',
  async ({ connector }) => {
    // SPEC ALIGNMENT: PASS
    /**
...
serverHttpTest(
  'should include hasMore flag in completion response [COMPLETION-001]',
  async ({ connector }) => {
    // SPEC ALIGNMENT: PASS
    /**
...
serverHttpTest(
  'should complete styled-prompt style argument [COMPLETION-001]',
  async ({ connector }) => {
    // SPEC ALIGNMENT: PASS
    /**
