/**
 * e2e tests for stdio transport completion flows
 *
 * validates completion/complete for prompt arguments and resource template
 * arguments using our StdioConnector against the coremcp test server
 * over stdio.
 */
...
describe('server-transport-stdio / completion', () => {
