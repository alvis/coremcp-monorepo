/**
 * cancellation tests for the coremcp stdio server transport via raw stdio session
 *
 ...
 * using the raw stdio session against our coremcp stdio server.
 * @see /e2e/interactions/12-cancellation.md for interaction specifications
 */

import { describe, it, expect, beforeAll, afterAll } from 'vitest';

import { createRawStdioSession } from '../fixtures/index';

import type { RawStdioSession } from '../fixtures/index';
...
describe('server-transport-stdio / 12-cancellation', () => {
  ...
  describe('client cancels in-flight request', () => {
    it('should complete faster than full duration when cancelled mid-flight [CANCEL-001]', async () => {
      ...
      rawSession.sendNotification('notifications/cancelled', {
