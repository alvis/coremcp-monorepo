...
// NOTE: http-test-fixtures.ts is NOT re-exported here because it calls
// vitest's test.extend() at module scope, which requires a test suite context.
// global-setup.ts imports from this file and runs outside that context.
// test files should import directly from './http-test-fixtures' instead.
