...
describe('client-connector-http / completion', () => {
  ...
  describe('completion/complete', () => {
    ...
    it('should complete resource template argument [COMPLETION-002]', async () => {
      // SPEC ALIGNMENT: PASS
      /**
       * verifies completion/complete supports resource template references as
       * well as prompt references.
       * @see https://modelcontextprotocol.io/specification/2025-11-25/server/utilities/completion#reference-types
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/protocol/src/schemas/2025-11-25/schema.ts#L1172-L1208 (CompleteRequest and CompleteResult)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/protocol/src/schemas/2025-11-25/schema.ts#L1224-L1235 (ResourceTemplateReference)
       * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/client/src/connector.ts#L311-L316 (complete)
       */
