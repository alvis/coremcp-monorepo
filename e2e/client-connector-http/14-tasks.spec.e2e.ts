/**
 * task lifecycle tests for HttpMcpConnector against server-everything
 *
 ...
 * as pending where task capabilities are unavailable.
...
describe('client-connector-http / 14-tasks', () => {
  describe('task creation', () => {
    it.todo(
      ...
      async () => {
         ...
         *
         * pseudo-code:
         * 1. connect the HttpMcpConnector to a task-capable fixture server instead of server-everything
  ...
  describe('task polling', () => {
    it.todo('should poll task status via tasks/get [TASK-002]', async () => {
      // SPEC ALIGNMENT: TODO
      /**
       ...
       *
       * @see https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks
       * @ ee https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/core/src/experimental/tasks/stores/inMemory.ts#L95 (getTask)
       */
    });
  });
  ...
  describe('task result retrieval', () => {
    it.todo(
      ...
      async () => {
         ...
         *
         * @see https://modelcontextprotocol.io/specification/2025-11-25/basic/utilities/tasks
         * @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0 @see https://github.com/modelcontextprotocol/typescript-sdk/blob/ccb78f20438a853f0205b8ed7f642af7780208e6/packages/core/src/experimental/tasks/stores/inMemory.ts#L134-L135 (getTaskResult)
         */
      },
    );
  });
  ...
  describe('task listing', () => {
    it.todo('should list tasks via tasks/list [TASK-004]', async () => {
      // SPEC ALIGNMENT: TODO
      /**
