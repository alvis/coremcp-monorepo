...
/**
 * proxies revocation request to external AS and cleans up local token mappings.
...
export async function handleRevoke(
  // eslint-disable-next-line @typescript-eslint/naming-convention -- OAuth wire format uses snake_case parameters per RFC 7009
