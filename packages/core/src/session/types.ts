...
import type { SetOptional, SetRequired } from '#types';

import type { SessionStore } from './store';

export type { ActiveRequestEntry } from './request-manager';
...
/** partial session event with optional id, channelId and timestamp for event creation */
export type SessionEventInput = SetOptional<
  SessionEvent,
  'id' | 'channelId' | 'occurredAt'
>;

/** mutable activity timestamps for a session */
